...
import cn.cleanarch.dmp.module.promotion.convert.price.PriceConvert;
...
import cn.cleanarch.dmp.module.promotion.enums.common.*;
import cn.cleanarch.dmp.module.promotion.enums.coupon.CouponStatusEnum;
import cn.cleanarch.dmp.module.promotion.service.coupon.CouponService;
import cn.cleanarch.dmp.module.promotion.service.discount.DiscountActivityService;
import cn.cleanarch.dmp.module.promotion.service.discount.bo.DiscountProductDetailBO;
import cn.cleanarch.dmp.module.promotion.service.reward.RewardActivityService;
...
import static cn.cleanarch.dmp.framework.common.util.collection.CollectionUtils.getSumValue;
import static cn.cleanarch.dmp.module.product.enums.ErrorCodeConstants.SKU_NOT_EXISTS;
import static cn.cleanarch.dmp.module.promotion.enums.ErrorCodeConstants.*;
...
//                            .setMeetTip(String.format("差 %s 元可用优惠劵", formatPrice(coupon.getUsePrice() - originPrice)));
     ...
     * 计算商品级别的价格，例如说：
     * 1. 会员折扣
     * 2. 限时折扣 {@link cn.cleanarch.dmp.module.promotion.dal.dataobject.discount.DiscountActivityDO}
     *
     * 其中，会员折扣、限时折扣取最低价
     *
     * @param userId 用户编号
    ...
    /**
     * 计算订单级别的价格，例如说：
     * 1. 满减送 {@link cn.cleanarch.dmp.module.promotion.dal.dataobject.reward.RewardActivityDO}
     *
     * @param userId 用户编号
     * @param priceCalculate 价格计算的结果
     */
