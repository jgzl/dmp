package cn.cleanarch.dmp.module.member.service.user;
...
import cn.cleanarch.dmp.module.member.controller.app.user.vo.AppUserUpdateMobileReqVO;
...
import cn.cleanarch.dmp.module.member.service.auth.MemberAuthServiceImpl;
 ...
 * @author 宋天
 */
@Import({MemberUserServiceImpl.class, DmpRedisAutoConfiguration.class})
