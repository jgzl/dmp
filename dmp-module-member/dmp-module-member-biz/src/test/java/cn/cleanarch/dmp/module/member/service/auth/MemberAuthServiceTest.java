...
import cn.cleanarch.dmp.module.member.controller.app.auth.vo.AppAuthResetPasswordReqVO;
import cn.cleanarch.dmp.module.member.controller.app.auth.vo.AppAuthUpdatePasswordReqVO;
 ...
 * @author 宋天
 */
@Import({MemberAuthServiceImpl.class, DmpRedisAutoConfiguration.class})
