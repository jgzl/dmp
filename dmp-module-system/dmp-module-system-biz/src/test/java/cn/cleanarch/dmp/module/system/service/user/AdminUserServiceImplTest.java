package cn.cleanarch.dmp.module.system.service.user;
...
import cn.cleanarch.dmp.module.infra.api.file.FileApi;
...
import cn.cleanarch.dmp.module.system.controller.admin.user.vo.user.*;
...
import cn.cleanarch.dmp.module.system.dal.dataobject.dept.UserPostDO;
...
import cn.cleanarch.dmp.module.system.dal.mysql.dept.UserPostMapper;
import cn.cleanarch.dmp.module.system.dal.mysql.user.AdminUserMapper;
import cn.cleanarch.dmp.module.system.enums.common.SexEnum;
...
import cn.cleanarch.dmp.module.system.service.tenant.TenantService;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("dmpyuanma");
        ...
        assertEquals("dmpyuanma", user.getPassword());
    ...
    public void testImportUsers_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("dmpyuanma"))).thenReturn("java");
