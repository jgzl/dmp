...
import cn.cleanarch.dmp.module.system.controller.admin.logger.vo.loginlog.LoginLogExportReqVO;
import cn.cleanarch.dmp.module.system.controller.admin.logger.vo.loginlog.LoginLogPageReqVO;
import cn.cleanarch.dmp.module.system.dal.dataobject.logger.LoginLogDO;
import cn.cleanarch.dmp.module.system.dal.mysql.logger.LoginLogMapper;
...
import static cn.cleanarch.dmp.module.system.enums.logger.LoginResultEnum.*;
...
public class LoginLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetLoginLogPage() {
        ...
        LoginLogDO loginLogDO = RandomUtils.randomPojo(LoginLogDO.class, logDO -> {
            logDO.setLogType(RandomUtil.randomEle(cn.cleanarch.dmp.module.system.enums.logger.LoginLogTypeEnum.values()).getType());
