...
import cn.cleanarch.dmp.framework.sms.config.DmpSmsAutoConfiguration;
import cn.cleanarch.dmp.module.system.test.BaseDbAndRedisIntegrationTest;
import cn.cleanarch.dmp.module.system.mq.consumer.sms.SmsSendConsumer;
...
// TODO @芋艿：需要迁移
@Import({DmpSmsAutoConfiguration.class,
