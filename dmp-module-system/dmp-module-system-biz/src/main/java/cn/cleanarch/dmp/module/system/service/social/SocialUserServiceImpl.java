...
public class SocialUserServiceImpl implements SocialUserService {
    ...
    @Resource// 由于自定义了 DmpAuthRequestFactory 无法覆盖默认的 AuthRequestFactory，所以只能注入它
    private DmpAuthRequestFactory dmpAuthRequestFactory;
    ...
    public String getAuthorizeUrl(Integer type, String redirectUri) {
        ...
        AuthRequest authRequest = dmpAuthRequestFactory.get(SocialTypeEnum.valueOfType(type).getSource());
        // 生成跳转地址
