...
import cn.cleanarch.dmp.framework.tenant.core.util.TenantUtils;
import cn.cleanarch.dmp.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import cn.cleanarch.dmp.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 dmp.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
