package cn.cleanarch.dmp.module.system.controller.admin.logger.vo.operatelog;
...
public class OperateLogBaseVO {
    ...
    @ApiModelProperty(value = "Java 方法名", required = true, example = "cn.cleanarch.dmp.adminserver.UserController.save(...)")
