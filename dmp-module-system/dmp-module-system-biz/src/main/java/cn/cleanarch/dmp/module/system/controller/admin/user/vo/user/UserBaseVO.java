package cn.cleanarch.dmp.module.system.controller.admin.user.vo.user;

import cn.cleanarch.dmp.framework.common.validation.Mobile;
...
public class UserBaseVO {
    ...
    @ApiModelProperty(value = "用户账号", required = true, example = "dmp")
    ...
    @ApiModelProperty(value = "用户邮箱", example = "dmp@iocoder.cn")
