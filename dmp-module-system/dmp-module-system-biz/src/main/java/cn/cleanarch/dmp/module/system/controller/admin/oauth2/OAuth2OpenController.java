...
import cn.cleanarch.dmp.framework.common.util.http.HttpUtils;
...
import cn.cleanarch.dmp.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAccessTokenRespVO;
import cn.cleanarch.dmp.module.system.controller.admin.oauth2.vo.open.OAuth2OpenAuthorizeInfoRespVO;
import cn.cleanarch.dmp.module.system.controller.admin.oauth2.vo.open.OAuth2OpenCheckTokenRespVO;
import cn.cleanarch.dmp.module.system.convert.oauth2.OAuth2OpenConvert;
import cn.cleanarch.dmp.module.system.dal.dataobject.oauth2.OAuth2AccessTokenDO;
import cn.cleanarch.dmp.module.system.dal.dataobject.oauth2.OAuth2ApproveDO;
import cn.cleanarch.dmp.module.system.dal.dataobject.oauth2.OAuth2ClientDO;
import cn.cleanarch.dmp.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import cn.cleanarch.dmp.module.system.service.oauth2.OAuth2ApproveService;
import cn.cleanarch.dmp.module.system.service.oauth2.OAuth2ClientService;
import cn.cleanarch.dmp.module.system.service.oauth2.OAuth2GrantService;
import cn.cleanarch.dmp.module.system.service.oauth2.OAuth2TokenService;
import cn.cleanarch.dmp.module.system.util.oauth2.OAuth2Utils;
...
import static cn.cleanarch.dmp.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static cn.cleanarch.dmp.framework.common.exception.util.ServiceExceptionUtil.exception0;
import static cn.cleanarch.dmp.framework.common.pojo.CommonResult.success;
import static cn.cleanarch.dmp.framework.common.util.collection.CollectionUtils.convertList;
