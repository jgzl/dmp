...
public class FileRespVO {
    ...
    @ApiModelProperty(value = "文件路径", required = true, example = "dmp.jpg")
    private String path;

    @ApiModelProperty(value = "原文件名", required = true, example = "dmp.jpg")
    private String name;

    @ApiModelProperty(value = "文件 URL", required = true, example = "https://www.iocoder.cn/dmp.jpg")
    private String url;
