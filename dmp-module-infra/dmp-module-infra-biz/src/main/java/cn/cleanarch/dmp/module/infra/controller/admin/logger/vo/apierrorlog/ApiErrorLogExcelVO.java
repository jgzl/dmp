package cn.cleanarch.dmp.module.infra.controller.admin.logger.vo.apierrorlog;
...
import cn.cleanarch.dmp.module.infra.enums.DictTypeConstants;
...
public class ApiErrorLogExcelVO {
    ...
    @DictFormat(cn.cleanarch.dmp.module.system.enums.DictTypeConstants.USER_TYPE)
