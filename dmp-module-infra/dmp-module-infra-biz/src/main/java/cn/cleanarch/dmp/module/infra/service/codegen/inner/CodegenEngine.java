package cn.cleanarch.dmp.module.infra.service.codegen.inner;
...
import cn.cleanarch.dmp.framework.excel.core.util.ExcelUtils;
import cn.cleanarch.dmp.framework.mybatis.core.dataobject.BaseDO;
...
import cn.cleanarch.dmp.module.infra.framework.codegen.config.CodegenProperties;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "dmp-module-${table.moduleName}/" + // 顶级模块
                "dmp-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "dmp-module-${table.moduleName}/" + // 顶级模块
                "dmp-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "dmp-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "dmp-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
}
