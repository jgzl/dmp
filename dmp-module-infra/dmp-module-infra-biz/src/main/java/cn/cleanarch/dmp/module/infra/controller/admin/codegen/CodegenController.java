package cn.cleanarch.dmp.module.infra.controller.admin.codegen;
...
import cn.cleanarch.dmp.framework.common.util.servlet.ServletUtils;
import cn.cleanarch.dmp.module.infra.controller.admin.codegen.vo.CodegenCreateListReqVO;
import cn.cleanarch.dmp.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import cn.cleanarch.dmp.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import cn.cleanarch.dmp.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
...
import cn.cleanarch.dmp.module.infra.service.codegen.CodegenService;
...
public class CodegenController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "name", value = "表名，模糊匹配", example = "dmp", dataTypeClass = String.class),
