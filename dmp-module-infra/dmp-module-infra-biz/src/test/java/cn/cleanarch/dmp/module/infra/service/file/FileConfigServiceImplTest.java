package cn.cleanarch.dmp.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import cn.cleanarch.dmp.framework.common.pojo.PageResult;
import cn.cleanarch.dmp.framework.file.core.client.FileClient;
import cn.cleanarch.dmp.framework.file.core.client.FileClientConfig;
import cn.cleanarch.dmp.framework.file.core.client.FileClientFactory;
import cn.cleanarch.dmp.framework.file.core.client.local.LocalFileClientConfig;
import cn.cleanarch.dmp.framework.file.core.enums.FileStorageEnum;
import cn.cleanarch.dmp.framework.test.core.ut.BaseDbUnitTest;
import cn.cleanarch.dmp.module.infra.controller.admin.file.vo.config.FileConfigCreateReqVO;
import cn.cleanarch.dmp.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import cn.cleanarch.dmp.module.infra.controller.admin.file.vo.config.FileConfigUpdateReqVO;
import cn.cleanarch.dmp.module.infra.dal.dataobject.file.FileConfigDO;
import cn.cleanarch.dmp.module.infra.dal.mysql.file.FileConfigMapper;
import cn.cleanarch.dmp.module.infra.mq.producer.file.FileConfigProducer;
import lombok.Data;
...
import static cn.cleanarch.dmp.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static cn.cleanarch.dmp.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static cn.cleanarch.dmp.framework.common.util.object.ObjectUtils.max;
import static cn.cleanarch.dmp.framework.test.core.util.AssertUtils.assertPojoEquals;
import static cn.cleanarch.dmp.framework.test.core.util.AssertUtils.assertServiceException;
import static cn.cleanarch.dmp.framework.test.core.util.RandomUtils.randomLongId;
import static cn.cleanarch.dmp.framework.test.core.util.RandomUtils.randomPojo;
import static cn.cleanarch.dmp.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static cn.cleanarch.dmp.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
