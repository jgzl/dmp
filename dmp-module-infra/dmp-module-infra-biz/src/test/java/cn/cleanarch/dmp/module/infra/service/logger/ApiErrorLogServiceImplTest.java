...
import cn.cleanarch.dmp.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogExportReqVO;
import cn.cleanarch.dmp.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import cn.cleanarch.dmp.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import cn.cleanarch.dmp.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import cn.cleanarch.dmp.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static cn.cleanarch.dmp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static cn.cleanarch.dmp.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        String applicationName = "dmp-test";
