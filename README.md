...
* 演示地址：<http://dashboard.dmp.iocoder.cn>
...
| `dmp-cloud`  | Spring Cloud 微服务       | **[Gitee](https://gitee.com/zhijiantianya/dmp-cloud)** &nbsp;&nbsp;&nbsp; [Github](https://github.com/YunaiV/dmp-cloud)         |
...
| 项目                    | 说明                 |
|-----------------------|--------------------|
| `dmp-dependencies`  | Maven 依赖版本管理       |
| `dmp-framework`     | Java 框架拓展          |
| `dmp-server`        | 管理后台 + 用户 APP 的服务端 |
| `dmp-ui-admin`      | 管理后台的 Vue2 前端项目        |
| `dmp-ui-admin-vue3`      | 管理后台的 Vue3 前端项目        |
| `dmp-ui-admin-uniapp`      | 管理后台的 uni-app 多端项目        |
| `dmp-ui-app`       | 用户 APP 的 UI 界面     |
| `dmp-module-system` | 系统功能的 Module 模块    |
| `dmp-module-member` | 会员中心的 Module 模块    |
| `dmp-module-infra`  | 基础设施的 Module 模块    |
| `dmp-module-tool`   | 研发工具的 Module 模块    |
| `dmp-module-bpm`    | 工作流程的 Module 模块    |
| `dmp-module-pay`    | 支付系统的 Module 模块    |
...
| [Druid](https://github.com/alibaba/druid)                                                   | JDBC 连接池、监控组件     | 1.2.15      | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?dmp) |
| [MyBatis Plus](https://mp.baomidou.com/)                                                    | MyBatis 增强工具包       | 3.5.2       | [文档](http://www.iocoder.cn/Spring-Boot/MyBatis/?dmp)         |
| [Dynamic Datasource](https://dynamic-datasource.com/)                                       | 动态数据源               | 3.5.2       | [文档](http://www.iocoder.cn/Spring-Boot/datasource-pool/?dmp) |
| [Redis](https://redis.io/)                                                                  | key-value 数据库        | 5.0 / 6.0   |                                                                |
| [Redisson](https://github.com/redisson/redisson)                                            | Redis 客户端            | 3.18.0      | [文档](http://www.iocoder.cn/Spring-Boot/Redis/?dmp)           |
| [Spring MVC](https://github.com/spring-projects/spring-framework/tree/master/spring-webmvc) | MVC 框架               | 5.3.24      | [文档](http://www.iocoder.cn/SpringMVC/MVC/?dmp)               |
| [Spring Security](https://github.com/spring-projects/spring-security)                       | Spring 安全框架         | 5.7.5       | [文档](http://www.iocoder.cn/Spring-Boot/Spring-Security/?dmp) |
| [Hibernate Validator](https://github.com/hibernate/hibernate-validator)                     | 参数校验组件             | 6.2.5       | [文档](http://www.iocoder.cn/Spring-Boot/Validation/?dmp)      |
| [Flowable](https://github.com/flowable/flowable-engine)                                     | 工作流引擎               | 6.7.2       | [文档](https://doc.iocoder.cn/bpm/)                                                     |
| [Quartz](https://github.com/quartz-scheduler)                                               | 任务调度组件             | 2.3.2       | [文档](http://www.iocoder.cn/Spring-Boot/Job/?dmp)             |
| [Knife4j](https://gitee.com/xiaoym/knife4j)                                                 | Swagger 增强 UI 实现    | 3.0.3       | [文档](http://www.iocoder.cn/Spring-Boot/Swagger/?dmp)         |
| [Resilience4j](https://github.com/resilience4j/resilience4j)                                | 服务保障组件             | 1.7.1       | [文档](http://www.iocoder.cn/Spring-Boot/Resilience4j/?dmp)    |
| [SkyWalking](https://skywalking.apache.org/)                                                | 分布式应用追踪系统        | 8.12.0      | [文档](http://www.iocoder.cn/Spring-Boot/SkyWalking/?dmp)      |
| [Spring Boot Admin](https://github.com/codecentric/spring-boot-admin)                       | Spring Boot 监控平台    | 2.7.7       | [文档](http://www.iocoder.cn/Spring-Boot/Admin/?dmp)           |
| [Jackson](https://github.com/FasterXML/jackson)                                             | JSON 工具库             | 2.13.3      |                                                                |
| [MapStruct](https://mapstruct.org/)                                                         | Java Bean 转换         | 1.5.3.Final | [文档](http://www.iocoder.cn/Spring-Boot/MapStruct/?dmp)       |
| [Lombok](https://projectlombok.org/)                                                        | 消除冗长的 Java 代码     | 1.18.24     | [文档](http://www.iocoder.cn/Spring-Boot/Lombok/?dmp)          |
| [JUnit](https://junit.org/junit5/)                                                          | Java 单元测试框架        | 5.8.2       | -                                                              |
| [Mockito](https://github.com/mockito/mockito)                                               | Java Mock 框架         | 4.8.2       | -                                                              |

### [管理后台 Vue2 前端](./dmp-ui-admin)
...
### [管理后台 Vue3 前端](./dmp-ui-admin-vue3)
...
### [管理后台 uni-app 跨端](./dmp-ui-admin-uniapp)
