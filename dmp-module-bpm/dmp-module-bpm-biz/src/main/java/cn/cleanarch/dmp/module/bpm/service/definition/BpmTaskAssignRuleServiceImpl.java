package cn.cleanarch.dmp.module.bpm.service.definition;
...
import cn.cleanarch.dmp.framework.common.util.object.ObjectUtils;
import cn.cleanarch.dmp.framework.datapermission.core.annotation.DataPermission;
import cn.cleanarch.dmp.framework.flowable.core.util.FlowableUtils;
import cn.cleanarch.dmp.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleCreateReqVO;
import cn.cleanarch.dmp.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleRespVO;
import cn.cleanarch.dmp.module.bpm.controller.admin.definition.vo.rule.BpmTaskAssignRuleUpdateReqVO;
import cn.cleanarch.dmp.module.bpm.convert.definition.BpmTaskAssignRuleConvert;
import cn.cleanarch.dmp.module.bpm.dal.dataobject.definition.BpmTaskAssignRuleDO;
import cn.cleanarch.dmp.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import cn.cleanarch.dmp.module.bpm.dal.mysql.definition.BpmTaskAssignRuleMapper;
import cn.cleanarch.dmp.module.bpm.enums.definition.BpmTaskAssignRuleTypeEnum;
import cn.cleanarch.dmp.module.bpm.enums.DictTypeConstants;
import cn.cleanarch.dmp.module.bpm.framework.flowable.core.behavior.script.BpmTaskAssignScript;
import cn.cleanarch.dmp.module.system.api.dept.DeptApi;
import cn.cleanarch.dmp.module.system.api.dept.PostApi;
import cn.cleanarch.dmp.module.system.api.dept.dto.DeptRespDTO;
import cn.cleanarch.dmp.module.system.api.dict.DictDataApi;
import cn.cleanarch.dmp.module.system.api.permission.PermissionApi;
import cn.cleanarch.dmp.module.system.api.permission.RoleApi;
import cn.cleanarch.dmp.module.system.api.user.AdminUserApi;
import cn.cleanarch.dmp.module.system.api.user.dto.AdminUserRespDTO;
...
import static cn.cleanarch.dmp.framework.common.util.collection.CollectionUtils.convertSet;
import static cn.cleanarch.dmp.framework.common.util.json.JsonUtils.toJsonString;
import static cn.cleanarch.dmp.module.bpm.enums.ErrorCodeConstants.*;
