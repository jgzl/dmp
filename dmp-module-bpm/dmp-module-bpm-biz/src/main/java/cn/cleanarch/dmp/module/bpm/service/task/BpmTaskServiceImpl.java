package cn.cleanarch.dmp.module.bpm.service.task;
...
import cn.cleanarch.dmp.framework.common.util.number.NumberUtils;
import cn.cleanarch.dmp.framework.common.util.object.PageUtils;
import cn.cleanarch.dmp.module.bpm.controller.admin.task.vo.task.*;
import cn.cleanarch.dmp.module.bpm.convert.task.BpmTaskConvert;
import cn.cleanarch.dmp.module.bpm.dal.dataobject.task.BpmTaskExtDO;
import cn.cleanarch.dmp.module.bpm.dal.mysql.task.BpmTaskExtMapper;
import cn.cleanarch.dmp.module.bpm.enums.task.BpmProcessInstanceDeleteReasonEnum;
import cn.cleanarch.dmp.module.bpm.enums.task.BpmProcessInstanceResultEnum;
import cn.cleanarch.dmp.module.bpm.service.message.BpmMessageService;
