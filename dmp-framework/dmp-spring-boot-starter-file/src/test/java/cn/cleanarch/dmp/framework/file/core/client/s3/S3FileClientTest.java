package cn.cleanarch.dmp.framework.file.core.client.s3;
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setDomain("http://test.dmp.iocoder.cn"); // 如果有自定义域名，则可以设置。http://static.dmp.iocoder.cn
        // 默认上海的 endpoint
