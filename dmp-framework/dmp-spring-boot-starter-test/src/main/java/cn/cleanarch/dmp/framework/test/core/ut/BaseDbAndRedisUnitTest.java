package cn.cleanarch.dmp.framework.test.core.ut;
...
import cn.cleanarch.dmp.framework.test.config.RedisTestConfiguration;
import cn.cleanarch.dmp.framework.test.config.SqlInitializationTestConfiguration;
