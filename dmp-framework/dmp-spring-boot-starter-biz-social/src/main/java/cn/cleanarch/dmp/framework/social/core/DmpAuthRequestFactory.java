package cn.cleanarch.dmp.framework.social.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.cleanarch.dmp.framework.social.core.enums.AuthExtendSource;
import cn.cleanarch.dmp.framework.social.core.request.AuthWeChatMiniAppRequest;
 ...
 * @date 2021-10-31
 */
public class DmpAuthRequestFactory extends AuthRequestFactory {
    ...
    public DmpAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
