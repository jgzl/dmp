package cn.cleanarch.dmp.framework.pay.core.client.impl;

import cn.hutool.core.lang.Assert;
import cn.cleanarch.dmp.framework.pay.core.client.PayClient;
import cn.cleanarch.dmp.framework.pay.core.client.PayClientConfig;
import cn.cleanarch.dmp.framework.pay.core.client.PayClientFactory;
import cn.cleanarch.dmp.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import cn.cleanarch.dmp.framework.pay.core.client.impl.alipay.AlipayPcPayClient;
import cn.cleanarch.dmp.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import cn.cleanarch.dmp.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import cn.cleanarch.dmp.framework.pay.core.client.impl.wx.WXLitePayClient;
import cn.cleanarch.dmp.framework.pay.core.client.impl.wx.WXNativePayClient;
import cn.cleanarch.dmp.framework.pay.core.client.impl.wx.WXPayClientConfig;
import cn.cleanarch.dmp.framework.pay.core.client.impl.wx.WXPubPayClient;
