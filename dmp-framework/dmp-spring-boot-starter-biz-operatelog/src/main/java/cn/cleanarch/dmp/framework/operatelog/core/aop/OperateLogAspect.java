package cn.cleanarch.dmp.framework.operatelog.core.aop;
...
import cn.cleanarch.dmp.framework.operatelog.core.enums.OperateTypeEnum;
...
import cn.cleanarch.dmp.framework.web.core.util.WebFrameworkUtils;
...
import static cn.cleanarch.dmp.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static cn.cleanarch.dmp.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, ApiOperation apiOperation) throws Throwable {
        ...
        cn.cleanarch.dmp.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                cn.cleanarch.dmp.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         cn.cleanarch.dmp.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           cn.cleanarch.dmp.framework.operatelog.core.annotations.OperateLog operateLog,
