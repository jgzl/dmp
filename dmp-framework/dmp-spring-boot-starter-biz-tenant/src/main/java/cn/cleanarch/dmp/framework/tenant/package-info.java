 ...
 *      1）Spring Async：
 *          {@link cn.cleanarch.dmp.framework.quartz.config.DmpAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 DmpSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package cn.cleanarch.dmp.framework.tenant;
