package cn.cleanarch.dmp.framework.swagger.config;

import cn.cleanarch.dmp.framework.swagger.core.SpringFoxHandlerProviderBeanPostProcessor;
...
import static cn.cleanarch.dmp.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
@ConditionalOnProperty(prefix = "dmp.swagger", value = "enable", matchIfMissing = true)
@EnableConfigurationProperties(SwaggerProperties.class)
public class DmpSwaggerAutoConfiguration {
...
//                .apis(basePackage("cn.cleanarch.dmp.module.system")) // 可用于 swagger 无法展示时使用
