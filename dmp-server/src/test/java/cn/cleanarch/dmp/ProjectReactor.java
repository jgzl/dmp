...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "cn.cleanarch.boot";
    private static final String ARTIFACT_ID = "dmp";
    private static final String PACKAGE_NAME = "cn.cleanarch.dmp";
    private static final String TITLE = "数据中台";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "cn.cleanarch.boot";
        String artifactIdNew = "dmp";
        String packageNameNew = "cn.cleanarch.dmp";
        String titleNew = "数据中台";
